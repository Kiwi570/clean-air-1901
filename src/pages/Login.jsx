...
import { Mail, Lock, ArrowRight, Home, Sparkles, CheckCircle, Star } from 'lucide-react'
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2.5 cursor-pointer group">
                <div className="relative">
                  ...
                  />
                  <div className="w-5 h-5 border-2 border-surface-300 rounded-md peer-checked:bg-brand-500 peer-checked:border-brand-500 transition-all" />
