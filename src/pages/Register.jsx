      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <p className="mt-6 text-sm text-surface-400 text-center">
            ...
            <a href="#" className="text-brand-600 hover:underline font-medium">CGU</a>
            {' '}et notre{' '}
            <a href="#" className="text-brand-600 hover:underline font-medium">politique de confidentialité</a>.
          </p>
