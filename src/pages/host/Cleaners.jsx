  ...
  const cleaners = [
    {
      ...
      bio: 'Professionnelle du ménage depuis 5 ans, spécialisée locations courte durée.',
      isFavorite: true,
    ...
    },
    {
      ...
      bio: 'Minutieux et ponctuel, je m\'adapte à vos besoins.',
      isFavorite: true,
    ...
    },
    {
      ...
      bio: 'Nouvelle sur la plateforme mais expérimentée. Qualité garantie !',
      isFavorite: false,
      lastCleaning: null,
      totalWithYou: 0,
    },
